...
function buildCharacter(outfit={}){
  ...
  // Cape (optional)
  if(o.capeColor){
    const cape=new THREE.Mesh(new THREE.BoxGeometry(0.62,0.80,0.05),mat(o.capeColor));
    cape.position.set(0,0.90,-0.19);g.add(cape);
    const lining=new THREE.Mesh(new THREE.BoxGeometry(0.56,0.73,0.02),mat(o.capeLining||0xffffff));
    lining.position.set(0,0.90,-0.22);g.add(lining);
  }
  return g;
}
